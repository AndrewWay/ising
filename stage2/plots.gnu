...
set ylabel "Magnetization per spin, <|M|>/N"
set xlabel "Temperature"
plot 'lat64.dat' u 1:4 w lp t "64", \
'lat32.dat' u 1:4 w lp t "32", \
'lat16.dat' u 1:4 w lp t "16", \
'lat08.dat' u 1:4 w lp t "8", \
'lat04.dat' u 1:4 w lp t "4", \
'lat02.dat' u 1:4 w lp t "2"
